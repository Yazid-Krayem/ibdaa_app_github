...
class QuizPageTest extends StatefulWidget {
  ...
  QuizPageTest(this.deviceId, this.cookieName, this.oldData) : super();
  @override
...
class _QuizPageState extends State<QuizPageTest> with TickerProviderStateMixin {
  final deviceId;
  final cookieName;
  final List oldData;
    ...
    return ClipRRect(
        ...
        child: Container(
          ...
          child: IndexedStack(
              ...
              children: widget.questionsListTest.map((question) {
                if (widget.questionsListTest.indexOf(question) <=
                    widget.questionsListTest.length) {
                  ...
                  children: [
                    for (var item in widget.listAnswers)
                      AnswersButtons(
                          ...
                          item: item,
                          currentIndex: widget.currentIndex,
                          lengthOflocalStorageItems:
                              widget.lengthOflocalStorageItems,
